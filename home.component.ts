...
export class HomeComponent implements OnInit, OnDestroy { 
  ...
  ngOnInit(): void {
    ...
    // Tự động chuyển câu nói sau mỗi 5 giây
  setInterval(() => {
    this.currentQuoteIndex = (this.currentQuoteIndex + 1) % this.comicQuotes.length;
  }, 5000);
  }
...
currentQuoteIndex = 0;
comicQuotes = [
  { text: "Một cuốn truyện hay có thể đưa bạn đến những thế giới kỳ ảo mà đôi chân không thể chạm tới.", author: "Khuyết Danh" },
  { text: "Truyện tranh không chỉ là hình vẽ, đó là những giấc mơ được kể bằng ngôn ngữ của sắc màu.", author: "Mọt Truyện" },
  { text: "Sức mạnh càng lớn, trách nhiệm càng cao.", author: "Stan Lee (Spider-Man)" },
  { text: "Con người ta mạnh mẽ nhất là khi bảo vệ người mình yêu thương.", author: "Masashi Kishimoto (Naruto)" },
  { text: "Đọc truyện để thấy rằng cuộc đời này vẫn còn rất nhiều phép màu chưa được khám phá.", author: "Góc Đọc Sách" }
];
